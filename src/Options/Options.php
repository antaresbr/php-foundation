...
class Options extends AbstractOptions
{
    ...
    public function get($key, $prototype = []): mixed
    {
        ...
        $value = Arr::get($this->storage, $key, $default);
     ...
     *
     * @param mixed $value The value with type to be validated
     * @param string $type The type to be validated
     * @param string|array $validTypes The acceptable types
     * @return bool
     */
    protected function isValidType(&$value, &$type, $validTypes): bool
    {
     ...
     * @return void
     */
    public function setPrototypes(array $prototypes): void
    {
        if (!empty($prototypes)) {
            ...
            foreach ($prototypes as $option => $prototype) {
                ...
                foreach (array_keys($validator->storage) as $key) {
     ...
     * @return static
     */
    public static function make(array $data = [], array $prototypes = []): static
    {
